...
{
	public class MortareController : TowerController
	{
		private MortareModel _model;
		private MortareView _view;

		public MortareController(MortareView view, MortareModel model)
		{
			_view = view;
			_model = model;
